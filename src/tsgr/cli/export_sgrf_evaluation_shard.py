"""Export completed SGRF prediction checkpoints for incremental transfer."""
...
from tsgr.baselines.sgrf_distributed import export_sgrf_evaluation_shard
...
def main() -> None:
    ...
    output = export_sgrf_evaluation_shard(
    ...
    print(f"SGRF evaluation shard saved to: {output}")
